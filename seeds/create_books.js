exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('books').insert({
      book_id: 1, author_id: 1, book_title: 'Python In A Nut Shell',
      book_genre: 'Python',
    ...
    knex('books').insert({
      book_id: 1, author_id: 2, book_title: 'Python In A Nut Shell',
      book_genre: 'Python',
      book_description: 'This book offers Python programmers one place to look when they need help remembering or deciphering the syntax of this open source language and its many powerful but scantily documented modules. This comprehensive reference guide makes it easy to look up the most frequently needed information--not just about the Python language itself, but also the most frequently used parts of the standard library and the most important third-party extensions.',
      book_cover_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/python_in_a_nutshell.jpg,'}),
    knex('books').insert({
      book_id: 1, author_id: 3, book_title: 'Python In A Nut Shell',
      book_genre: 'Python',
      book_description: 'This book offers Python programmers one place to look when they need help remembering or deciphering the syntax of this open source language and its many powerful but scantily documented modules. This comprehensive reference guide makes it easy to look up the most frequently needed information--not just about the Python language itself, but also the most frequently used parts of the standard library and the most important third-party extensions.',
      book_cover_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/python_in_a_nutshell.jpg,'}),
    knex('books').insert({
      book_id: 2, author_id: 4, book_title: 'Think Python',
      book_genre: 'Python',
    ...
    knex('books').insert({
      book_id: 3, author_id: 5, book_title: 'Learning React Native',
    ...
    knex('books').insert({
      book_id: 4, author_id: 6, book_title: "You Don't Know JS: ES6 & Beyond",
      book_genre: 'Javascript',
    ...
    knex('books').insert({
      book_id: 5, author_id: 6, book_title: "You Don't Know JS: Scope & Closures",
      book_genre: 'Javascript',
    ...
    knex('books').insert({
      book_id: 6, author_id: 6, book_title: "You Don't Know JS: Async & Performance",
      book_genre: 'Javascript',
